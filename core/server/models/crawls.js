...
Crawl = ghostBookshelf.Model.extend({
...
Crawls = ghostBookshelf.Collection.extend({
    model: Crawl
});

module.exports = {
    Crawl: ghostBookshelf.model('Crawl', Crawl),
    Crawls: ghostBookshelf.collection('Crawls', Crawls)
};
